...
//			CubicPolynomial xqp = new CubicPolynomial(sx, vxs, axs, gx, vxg, axg, T);
//			CubicPolynomial yqp = new CubicPolynomial(sy, vys, ays, gy, vyg, ayg, T);
//
//			time.clear();
//			rx.clear();
//			ry.clear();
